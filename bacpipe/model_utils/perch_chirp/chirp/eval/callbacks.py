...
from bacpipe.model_utils.perch_chirp.chirp.projects.zoo import (
    models as inference_models,
)
...
class EmbeddingModelCallback:
    ...
    def __call__(self, inputs: np.ndarray) -> np.ndarray:
        ...
        return model_outputs.pooled_embeddings(self.time_pooling, self.channel_pooling)
