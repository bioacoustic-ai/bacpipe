...
_PREFIX = flags.DEFINE_string(
    "prefix",
    "ebird2022",
    "The prefix to attach to the generated namespaces, class lists, and" " mappings.",
)
...
def parse_ebird(
    ...
    mappings = {
        ("to_species", "", "species"): df[
            ...
            df.merge(df, left_on="REPORT_AS", right_on="SPECIES_CODE", how="left")[
                "CATEGORY_y"
            ]
            == "species"
        ][["SPECIES_CODE", "REPORT_AS"]],
        ("clements_to_species", "clements", "species"): df[df["CATEGORY"] == "species"][
