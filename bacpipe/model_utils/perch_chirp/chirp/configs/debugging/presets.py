...
from bacpipe.model_utils.perch_chirp.chirp.config_utils import object_config as _o
...
def get_supervised_train_pipeline(
    ...
    if random_gain:
        ops.append(_c("pipeline.RandomNormalizeAudio", min_gain=0.15, max_gain=0.25))
