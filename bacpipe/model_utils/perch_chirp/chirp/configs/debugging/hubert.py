...
from bacpipe.model_utils.perch_chirp.chirp.configs.debugging import hubert_presets
...
def get_config() -> config_dict.ConfigDict:
    ...
    model_config.late_feature_extractor = _c("conformer.Conformer", conformer_config)
...
def get_hyper(hyper):
    return hyper.sweep("config.init_config.learning_rate", hyper.discrete([0.0001]))
