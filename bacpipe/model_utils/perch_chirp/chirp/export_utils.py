...
class Jax2TfModelWrapper(tf.Module):
    ...
    def __init__(
        ...
        infer_partial = (
            lambda inputs: converted_infer_fn(  # pylint:disable=g-long-lambda
    ...
    def export_converted_model(
        ...
        converter = tf.lite.TFLiteConverter.from_concrete_functions([concrete_fn], self)
        ...
        with tf.io.gfile.GFile(os.path.join(export_dir, "tflite_ckpt.txt"), "w") as f:
            f.write(f"train_state.step: {train_step}\n")
