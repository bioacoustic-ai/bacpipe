...
from bacpipe.model_utils.perch_chirp.chirp.data.bird_taxonomy import premade_queries
...
class BirdTaxonomy(tfds.core.GeneratorBasedBuilder):
    ...
    RELEASE_NOTES = {
        ...
        "2.0.0": ("Updated the upstream split to align with Coffee Farms and Hawai'i."),
        "2.1.0": (
    ...
    BUILDER_CONFIGS = [
        ...
        BirdTaxonomyConfig(
            ...
            localization_fn=audio_utils.slice_peaked_audio,
            interval_length_s=6.0,
            data_processing_query=premade_queries.get_upstream_data_query(ar_only=True),
            metadata_processing_query=premade_queries.get_upstream_metadata_query(),
            description=(
        ...
        BirdTaxonomyConfig(
            ...
            data_processing_query=premade_queries.get_upstream_data_query(ar_only=True),
            metadata_processing_query=premade_queries.get_upstream_metadata_query(),
            description=("Upstream data (AR-only) with full-length audio sequences."),
        ),
        BirdTaxonomyConfig(
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        source_info = (
            taxonomy_info[
                taxonomy_info["xeno_canto_ids"].map(lambda xc_ids: bool(len(xc_ids)))
            ]
            .set_index(
                [
                    "species_code",
