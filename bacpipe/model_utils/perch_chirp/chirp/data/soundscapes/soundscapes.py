...
class Soundscapes(bird_taxonomy.BirdTaxonomy):
    ...
    RELEASE_NOTES = {
        ...
        "1.0.1": (
            "The label set is now restricted to the species present in each" "dataset."
        ),
        "1.0.2": (
    ...
    BUILDER_CONFIGS = [
        ...
        SoundscapesConfig(
            ...
            annotation_filename="annotations.csv",
            keep_unknown_annotation=True,
            description=("High Sierras recordings. https://zenodo.org/record/7525805"),
        ...
        SoundscapesConfig(
            ...
            annotation_filename="annotations.csv",
            keep_unknown_annotation=True,
            description=("Sierra Nevada recordings. https://zenodo.org/record/7050014"),
                ...
                with warnings.catch_warnings():
                    ...
                    if not full_length:
                        ...
                        if len(audio) < target_length:
                            logging.warning(
                                "Skipping audio at %s because too short.", url
                            )
                            return []
