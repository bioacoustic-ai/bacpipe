...
from bacpipe.model_utils.perch_chirp.chirp.inference.search import bootstrap
...
def display_search_results(
    ...
    **kwargs,
    ...
    results_iterator = project_state.search_results_audio_iterator(results, **kwargs)
...
def display_paged_results(
    ...
    **kwargs,
    ...
    prev_page_button.on_click(lambda x: increment_page_callback(x, -1, page_state))
