...
from bacpipe.model_utils.perch_chirp.chirp.models import cwt
...
class MorletWaveletTransform(Frontend):
    ...
    def __call__(self, inputs: jnp.ndarray, train: bool = True) -> jnp.ndarray:
        ...
        params = cwt.melspec_params(self.features, self.sample_rate, *self.freq_range)
        ...
        gabor_filter = cwt.gabor_filter(sigma, cwt.Domain.TIME, cwt.Normalization.L1)
