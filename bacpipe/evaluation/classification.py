...
def evaluating_on_task(
    ...
    embeddings_path="bacpipe/bacpipe/evaluation/embeddings",
    task_config_path="bacpipe/bacpipe/evaluation/tasks/ID/ID.json",
    device_str="cuda",
    wandb_configs_path="bacpipe/bacpipe/evaluation/evaluation_utils/wandb_config.json",
):
    """
