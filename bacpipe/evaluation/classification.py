...
from evaluation_utils.linear_probe import LinearProbe, train_linear_probe, inference_with_linear_probe
...
def evaluating_on_task(task_name='ID',   pretrained_model='birdnet',embeddings_size=1024,  embeddings_path='bacpipe/bacpipe/evaluation/embeddings', task_config_path='bacpipe/bacpipe/evaluation/tasks/ID/ID.json', device_str = 'cuda', wandb_configs_path='bacpipe/bacpipe/evaluation/evaluation_utils/wandb_config.json'):
    ...
    overall_metrics, per_class_metrics = compute_metrics(predictions, gt_indexes, probability_scores, config["label_to_index"])
...
if __name__ == '__main__':
    ...
    embeddings_path = '/import/c4dm-datasets-ext/animal_id_FEBdataset/pretrained_embeddings/birdnet'
