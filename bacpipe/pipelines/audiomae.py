...
import bacpipe.model_utils.audiomae.models_vit as models_vit
...
class Model(ModelBaseClass):
    def __init__(self):
        ...
        self.in_chans = 1
        self.emb_dim = 768
        self.audio_conf_val = {'num_mel_bins': 128, 
        ...
        self.model.patch_embed = PatchEmbed_new(img_size=self.img_size, 
                                                patch_size=(16,16), 
                                                in_chans=1, 
        ...
        self.model.pos_embed = nn.Parameter(torch.zeros(1, num_patches + 1, 
                                                        self.emb_dim), 
